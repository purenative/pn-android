...
enum class PNComponentsEnum(val componentName: String) {
    GifImageComponent(componentName = "GifImageComponent"),
    CalendarComponent(componentName = "CalendarComponent"),
    IndicatorComponent(componentName = "IndicatorComponent"),
